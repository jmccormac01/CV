...
\parbox[t]{12.8cm}{
    ...
    I have written two data analysis pipelines for analysing and modelling large sets of photometric and spectroscopic data from low-mass eclipsing binary (EBLM) stars. EBLMs are pairs of stars where the secondary star has a mass between that of Jupiter and a very low-mass star. The goal of my pipeline is to calibration and extract data from various instruments and model the data to measure precise masses and radii for new EBLMs. 
    \vspace{\parsep}\\
    Core Skills:
    \begin{itemize}
